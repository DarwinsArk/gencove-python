...
class TestBaseSpaceProjectsImport(unittest.TestCase):
    """BaseSpaceProjectsImport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseSpaceProjectsImport:
        """Test BaseSpaceProjectsImport
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BaseSpaceProjectsImport`
        """
        model = BaseSpaceProjectsImport()
        if include_optional:
            return BaseSpaceProjectsImport(
                project_id = '',
    ...
    def testBaseSpaceProjectsImport(self):
        """Test BaseSpaceProjectsImport"""
