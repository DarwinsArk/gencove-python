...
class TestBaseSpaceProject(unittest.TestCase):
    """BaseSpaceProject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseSpaceProject:
        """Test BaseSpaceProject
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BaseSpaceProject`
        """
        model = BaseSpaceProject()
        if include_optional:
            return BaseSpaceProject(
                basespace_id = '0',
                basespace_name = '0',
