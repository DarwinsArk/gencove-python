...
class TestTraitScoreSelfNested(unittest.TestCase):
    """TraitScoreSelfNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TraitScoreSelfNested:
        """Test TraitScoreSelfNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TraitScoreSelfNested`
        """
        model = TraitScoreSelfNested()
        if include_optional:
            return TraitScoreSelfNested(
                value = 1.337,
                percentile = 1.337
            )
        else:
    ...
    def testTraitScoreSelfNested(self):
        """Test TraitScoreSelfNested"""
