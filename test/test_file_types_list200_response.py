...
class TestFileTypesList200Response(unittest.TestCase):
    """FileTypesList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileTypesList200Response:
        """Test FileTypesList200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FileTypesList200Response`
        """
        model = FileTypesList200Response()
        if include_optional:
            return FileTypesList200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.file_type.FileType(
                        key = '0',
                        description = '', )
                    ]
            )
    ...
    def testFileTypesList200Response(self):
        """Test FileTypesList200Response"""
