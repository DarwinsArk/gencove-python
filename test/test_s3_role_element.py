...
class TestS3RoleElement(unittest.TestCase):
    """S3RoleElement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> S3RoleElement:
        """Test S3RoleElement
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `S3RoleElement`
        """
        model = S3RoleElement()
        if include_optional:
            return S3RoleElement(
                role_arn = '',
                external_id = '',
                aws_region = '',
                s3_bucket = '',
