...
class TestSampleStatusNested(unittest.TestCase):
    """SampleStatusNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleStatusNested:
        """Test SampleStatusNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleStatusNested`
        """
        model = SampleStatusNested()
        if include_optional:
            return SampleStatusNested(
                id = '',
                status = '0',
                note = '',
    ...
    def testSampleStatusNested(self):
        """Test SampleStatusNested"""
