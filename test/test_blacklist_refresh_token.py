...
class TestBlacklistRefreshToken(unittest.TestCase):
    """BlacklistRefreshToken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlacklistRefreshToken:
        """Test BlacklistRefreshToken
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BlacklistRefreshToken`
        """
    ...
    def testBlacklistRefreshToken(self):
        """Test BlacklistRefreshToken"""
