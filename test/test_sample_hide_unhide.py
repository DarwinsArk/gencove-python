...
class TestSampleHideUnhide(unittest.TestCase):
    """SampleHideUnhide unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleHideUnhide:
        """Test SampleHideUnhide
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleHideUnhide`
        """
        model = SampleHideUnhide()
        if include_optional:
            return SampleHideUnhide(
                sample_ids = [
                    ''
                    ]
            )
