...
class TestProjectSubscriptionsList200Response(unittest.TestCase):
    """ProjectSubscriptionsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSubscriptionsList200Response:
        """Test ProjectSubscriptionsList200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectSubscriptionsList200Response`
        """
        model = ProjectSubscriptionsList200Response()
        if include_optional:
            return ProjectSubscriptionsList200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.project_subscription.ProjectSubscription(
                        id = '',
                        name = '0',
                        project = '',
                        target = '0',
    ...
    def testProjectSubscriptionsList200Response(self):
        """Test ProjectSubscriptionsList200Response"""
