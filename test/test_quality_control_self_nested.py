...
class TestQualityControlSelfNested(unittest.TestCase):
    """QualityControlSelfNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QualityControlSelfNested:
        """Test QualityControlSelfNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `QualityControlSelfNested`
        """
        model = QualityControlSelfNested()
        if include_optional:
            return QualityControlSelfNested(
    ...
    def testQualityControlSelfNested(self):
        """Test QualityControlSelfNested"""
