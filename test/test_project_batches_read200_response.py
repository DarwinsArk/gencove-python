...
class TestProjectBatchesRead200Response(unittest.TestCase):
    """ProjectBatchesRead200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectBatchesRead200Response:
        """Test ProjectBatchesRead200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectBatchesRead200Response`
        """
        model = ProjectBatchesRead200Response()
        if include_optional:
            return ProjectBatchesRead200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.batch_list.BatchList(
                        id = '',
                        name = '',
                        batch_type = '',
                        last_status = gencove_client.models.batch_status_nested.BatchStatusNested(
                            id = '',
                            status = '0',
                            created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
                        files = [
                            gencove_client.models.batch_file_nested.BatchFileNested(
                                id = '',
                                s3_path = '',
    ...
    def testProjectBatchesRead200Response(self):
        """Test ProjectBatchesRead200Response"""
