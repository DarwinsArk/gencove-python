...
class TestProjectShareStatus(unittest.TestCase):
    """ProjectShareStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectShareStatus:
        """Test ProjectShareStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectShareStatus`
        """
        model = ProjectShareStatus()
        if include_optional:
    ...
    def testProjectShareStatus(self):
        """Test ProjectShareStatus"""
