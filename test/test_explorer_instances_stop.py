...
class TestExplorerInstancesStop(unittest.TestCase):
    """ExplorerInstancesStop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExplorerInstancesStop:
        """Test ExplorerInstancesStop
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExplorerInstancesStop`
        """
        model = ExplorerInstancesStop()
        if include_optional:
            return ExplorerInstancesStop(
                instance_ids = [
                    ''
                    ]
            )
    ...
    def testExplorerInstancesStop(self):
        """Test ExplorerInstancesStop"""
