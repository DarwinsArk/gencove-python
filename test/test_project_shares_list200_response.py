...
class TestProjectSharesList200Response(unittest.TestCase):
    """ProjectSharesList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSharesList200Response:
        """Test ProjectSharesList200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectSharesList200Response`
        """
        model = ProjectSharesList200Response()
        if include_optional:
            return ProjectSharesList200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.project_share.ProjectShare(
                        id = '',
                        project = '',
                        shared_with_org = '0',
                        shared_with_org_name = '0',
                        shared_with_user_emails = [
                            '0'
                            ],
                        shared_with_user_email = '0',
                        shared_by_user_email = '0',
                        share_level = '0',
                        last_status = gencove_client.models.project_share_status.ProjectShareStatus(
                            id = '',
                            status = 'shared',
                            note = '',
    ...
    def testProjectSharesList200Response(self):
        """Test ProjectSharesList200Response"""
