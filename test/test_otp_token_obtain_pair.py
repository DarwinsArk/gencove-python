...
class TestOTPTokenObtainPair(unittest.TestCase):
    """OTPTokenObtainPair unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OTPTokenObtainPair:
        """Test OTPTokenObtainPair
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `OTPTokenObtainPair`
        """
        model = OTPTokenObtainPair()
        if include_optional:
            return OTPTokenObtainPair(
                otp_token = '0',
                backup_token = '0',
                email = '0',
                password = '0'
    ...
    def testOTPTokenObtainPair(self):
        """Test OTPTokenObtainPair"""
