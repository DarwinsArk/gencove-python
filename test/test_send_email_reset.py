...
class TestSendEmailReset(unittest.TestCase):
    """SendEmailReset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEmailReset:
        """Test SendEmailReset
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SendEmailReset`
        """
        model = SendEmailReset()
        if include_optional:
