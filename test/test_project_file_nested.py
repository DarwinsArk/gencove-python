...
class TestProjectFileNested(unittest.TestCase):
    """ProjectFileNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectFileNested:
        """Test ProjectFileNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectFileNested`
        """
        model = ProjectFileNested()
        if include_optional:
            return ProjectFileNested(
                id = '',
                s3_path = '',
    ...
    def testProjectFileNested(self):
        """Test ProjectFileNested"""
