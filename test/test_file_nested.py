...
class TestFileNested(unittest.TestCase):
    """FileNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileNested:
        """Test FileNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FileNested`
        """
        model = FileNested()
        if include_optional:
            return FileNested(
