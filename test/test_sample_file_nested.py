...
class TestSampleFileNested(unittest.TestCase):
    """SampleFileNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleFileNested:
        """Test SampleFileNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleFileNested`
        """
        model = SampleFileNested()
        if include_optional:
            return SampleFileNested(
                id = '',
                s3_path = '',
