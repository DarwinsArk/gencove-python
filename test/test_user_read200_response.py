...
class TestUserRead200Response(unittest.TestCase):
    """UserRead200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserRead200Response:
        """Test UserRead200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UserRead200Response`
        """
        model = UserRead200Response()
        if include_optional:
            return UserRead200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.user.User(
                        id = '',
                        email = '0',
                        name = '',
                        uploads_enabled = '',
    ...
    def testUserRead200Response(self):
        """Test UserRead200Response"""
