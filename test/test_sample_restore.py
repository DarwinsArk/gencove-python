...
class TestSampleRestore(unittest.TestCase):
    """SampleRestore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleRestore:
        """Test SampleRestore
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleRestore`
        """
        model = SampleRestore()
        if include_optional:
            return SampleRestore(
                sample_ids = [
                    ''
                    ],
                restore_group_id = '',
