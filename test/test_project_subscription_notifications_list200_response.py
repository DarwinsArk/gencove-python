...
class TestProjectSubscriptionNotificationsList200Response(unittest.TestCase):
    """ProjectSubscriptionNotificationsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSubscriptionNotificationsList200Response:
        """Test ProjectSubscriptionNotificationsList200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectSubscriptionNotificationsList200Response`
        """
        model = ProjectSubscriptionNotificationsList200Response()
        if include_optional:
            return ProjectSubscriptionNotificationsList200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.project_subscription_notification.ProjectSubscriptionNotification(
                        id = '',
    ...
    def testProjectSubscriptionNotificationsList200Response(self):
        """Test ProjectSubscriptionNotificationsList200Response"""
