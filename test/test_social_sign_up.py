...
class TestSocialSignUp(unittest.TestCase):
    """SocialSignUp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialSignUp:
        """Test SocialSignUp
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SocialSignUp`
        """
        model = SocialSignUp()
        if include_optional:
            return SocialSignUp(
