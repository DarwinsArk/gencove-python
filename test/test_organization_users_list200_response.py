...
class TestOrganizationUsersList200Response(unittest.TestCase):
    """OrganizationUsersList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationUsersList200Response:
        """Test OrganizationUsersList200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `OrganizationUsersList200Response`
        """
        model = OrganizationUsersList200Response()
        if include_optional:
            return OrganizationUsersList200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.organization_user.OrganizationUser(
                        id = '',
                        email = '0',
                        is_active = True,
                        has_mfa_device = True,
    ...
    def testOrganizationUsersList200Response(self):
        """Test OrganizationUsersList200Response"""
