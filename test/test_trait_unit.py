...
class TestTraitUnit(unittest.TestCase):
    """TraitUnit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TraitUnit:
        """Test TraitUnit
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TraitUnit`
        """
        model = TraitUnit()
        if include_optional:
            return TraitUnit(
