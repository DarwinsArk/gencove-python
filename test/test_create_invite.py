...
class TestCreateInvite(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateInvite:
        """Test CreateInvite
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreateInvite`
        """
        model = CreateInvite()
        if include_optional:
            return CreateInvite(
