...
class TestAncestryMetadata(unittest.TestCase):
    """AncestryMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AncestryMetadata:
        """Test AncestryMetadata
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AncestryMetadata`
        """
        model = AncestryMetadata()
        if include_optional:
            return AncestryMetadata(
