...
class TestS3ExternalID(unittest.TestCase):
    """S3ExternalID unit test stubs"""
    ...
    def make_instance(self, include_optional) -> S3ExternalID:
        """Test S3ExternalID
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `S3ExternalID`
        """
        model = S3ExternalID()
        if include_optional:
            return S3ExternalID(
