...
class TestFastqsNestedCreate(unittest.TestCase):
    """FastqsNestedCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FastqsNestedCreate:
        """Test FastqsNestedCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FastqsNestedCreate`
        """
        model = FastqsNestedCreate()
        if include_optional:
            return FastqsNestedCreate(
    ...
    def testFastqsNestedCreate(self):
        """Test FastqsNestedCreate"""
