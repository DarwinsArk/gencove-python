...
class TestExplorerInstance(unittest.TestCase):
    """ExplorerInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExplorerInstance:
        """Test ExplorerInstance
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExplorerInstance`
        """
        model = ExplorerInstance()
        if include_optional:
