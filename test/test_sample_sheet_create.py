...
class TestSampleSheetCreate(unittest.TestCase):
    """SampleSheetCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleSheetCreate:
        """Test SampleSheetCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleSheetCreate`
        """
        model = SampleSheetCreate()
        if include_optional:
            return SampleSheetCreate(
                client_id = '0',
    ...
    def testSampleSheetCreate(self):
        """Test SampleSheetCreate"""
