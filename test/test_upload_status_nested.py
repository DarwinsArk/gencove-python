...
class TestUploadStatusNested(unittest.TestCase):
    """UploadStatusNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadStatusNested:
        """Test UploadStatusNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UploadStatusNested`
        """
        model = UploadStatusNested()
        if include_optional:
            return UploadStatusNested(
                id = '',
                status = '0',
                note = '',
    ...
    def testUploadStatusNested(self):
        """Test UploadStatusNested"""
