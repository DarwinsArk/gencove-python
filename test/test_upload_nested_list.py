...
class TestUploadNestedList(unittest.TestCase):
    """UploadNestedList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadNestedList:
        """Test UploadNestedList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UploadNestedList`
        """
        model = UploadNestedList()
        if include_optional:
            return UploadNestedList(
                upload = '',
                destination_path = '',
