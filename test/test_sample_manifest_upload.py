...
class TestSampleManifestUpload(unittest.TestCase):
    """SampleManifestUpload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleManifestUpload:
        """Test SampleManifestUpload
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleManifestUpload`
        """
        model = SampleManifestUpload()
        if include_optional:
            return SampleManifestUpload(
                sample_manifest = ''
            )
        else:
            return SampleManifestUpload(
    ...
    def testSampleManifestUpload(self):
        """Test SampleManifestUpload"""
