...
class TestInviteOrganization(unittest.TestCase):
    """InviteOrganization unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InviteOrganization:
        """Test InviteOrganization
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InviteOrganization`
        """
    ...
    def testInviteOrganization(self):
        """Test InviteOrganization"""
