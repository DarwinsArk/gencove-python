...
class TestS3ObjectNested(unittest.TestCase):
    """S3ObjectNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> S3ObjectNested:
        """Test S3ObjectNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `S3ObjectNested`
        """
        model = S3ObjectNested()
        if include_optional:
