...
class TestTraitScore(unittest.TestCase):
    """TraitScore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TraitScore:
        """Test TraitScore
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TraitScore`
        """
        model = TraitScore()
        if include_optional:
            return TraitScore(
