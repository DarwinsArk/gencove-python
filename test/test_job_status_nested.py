...
class TestJobStatusNested(unittest.TestCase):
    """JobStatusNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobStatusNested:
        """Test JobStatusNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `JobStatusNested`
        """
        model = JobStatusNested()
        if include_optional:
            return JobStatusNested(
                id = '',
                status = '0',
                note = '',
