...
class TestBaseSpaceBioSampleNested(unittest.TestCase):
    """BaseSpaceBioSampleNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseSpaceBioSampleNested:
        """Test BaseSpaceBioSampleNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BaseSpaceBioSampleNested`
        """
        model = BaseSpaceBioSampleNested()
        if include_optional:
            return BaseSpaceBioSampleNested(
                basespace_id = '0',
                client_id = '0',
                sample = ''
            )
    ...
    def testBaseSpaceBioSampleNested(self):
        """Test BaseSpaceBioSampleNested"""
