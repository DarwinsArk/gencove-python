...
class TestPipelineList200Response(unittest.TestCase):
    """PipelineList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PipelineList200Response:
        """Test PipelineList200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PipelineList200Response`
        """
        model = PipelineList200Response()
        if include_optional:
            return PipelineList200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.pipeline_list.PipelineList(
                        id = '',
                        version = '0', )
                    ]
            )
    ...
    def testPipelineList200Response(self):
        """Test PipelineList200Response"""
