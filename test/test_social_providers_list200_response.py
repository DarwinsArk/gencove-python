...
class TestSocialProvidersList200Response(unittest.TestCase):
    """SocialProvidersList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialProvidersList200Response:
        """Test SocialProvidersList200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SocialProvidersList200Response`
        """
        model = SocialProvidersList200Response()
        if include_optional:
            return SocialProvidersList200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.social_provider.SocialProvider(
                        name = '0',
                        authorization_uri = '0',
                        accounts = [
                            gencove_client.models.social_account_nested.SocialAccountNested(
                                id = '',
                                created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                                social_account_id = '0',
                                auth_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), )
                            ], )
                    ]
            )
        else:
    ...
    def testSocialProvidersList200Response(self):
        """Test SocialProvidersList200Response"""
