...
class TestSampleAncestry(unittest.TestCase):
    """SampleAncestry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleAncestry:
        """Test SampleAncestry
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleAncestry`
        """
        model = SampleAncestry()
        if include_optional:
            return SampleAncestry(
                ancestry = gencove_client.models.ancestry_self_nested.AncestrySelfNested(
                    value = gencove_client.models.value.Value(), ),
                metadata = gencove_client.models.ancestry_metadata.AncestryMetadata(
                    value = gencove_client.models.value.Value(), )
            )
        else:
            return SampleAncestry(
