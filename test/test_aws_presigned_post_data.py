...
class TestAWSPresignedPostData(unittest.TestCase):
    """AWSPresignedPostData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AWSPresignedPostData:
        """Test AWSPresignedPostData
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AWSPresignedPostData`
        """
        model = AWSPresignedPostData()
        if include_optional:
            return AWSPresignedPostData(
                key = '0',
                aws_access_key_id = '0',
                policy = '0',
                signature = '0'
    ...
    def testAWSPresignedPostData(self):
        """Test AWSPresignedPostData"""
