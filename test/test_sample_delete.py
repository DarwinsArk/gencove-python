...
class TestSampleDelete(unittest.TestCase):
    """SampleDelete unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleDelete:
        """Test SampleDelete
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleDelete`
        """
        model = SampleDelete()
        if include_optional:
            return SampleDelete(
