...
class TestProjectSamplesImport(unittest.TestCase):
    """ProjectSamplesImport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSamplesImport:
        """Test ProjectSamplesImport
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectSamplesImport`
        """
        model = ProjectSamplesImport()
        if include_optional:
            return ProjectSamplesImport(
                project_id = '',
                samples = [
                    gencove_client.models.existing_sample.ExistingSample(
                        client_id = '0',
                        sample_id = '', )
                    ],
    ...
    def testProjectSamplesImport(self):
        """Test ProjectSamplesImport"""
