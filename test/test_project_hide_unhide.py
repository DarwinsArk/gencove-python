...
class TestProjectHideUnhide(unittest.TestCase):
    """ProjectHideUnhide unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectHideUnhide:
        """Test ProjectHideUnhide
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectHideUnhide`
        """
        model = ProjectHideUnhide()
        if include_optional:
            return ProjectHideUnhide(
                project_ids = [
                    ''
                    ]
            )
    ...
    def testProjectHideUnhide(self):
        """Test ProjectHideUnhide"""
