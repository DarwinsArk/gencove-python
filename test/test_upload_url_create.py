...
class TestUploadURLCreate(unittest.TestCase):
    """UploadURLCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadURLCreate:
        """Test UploadURLCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UploadURLCreate`
        """
        model = UploadURLCreate()
        if include_optional:
            return UploadURLCreate(
                destination_path = '0',
                source_url = '0'
            )
        else:
