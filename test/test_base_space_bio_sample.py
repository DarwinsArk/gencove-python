...
class TestBaseSpaceBioSample(unittest.TestCase):
    """BaseSpaceBioSample unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseSpaceBioSample:
        """Test BaseSpaceBioSample
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BaseSpaceBioSample`
        """
        model = BaseSpaceBioSample()
        if include_optional:
            return BaseSpaceBioSample(
                basespace_id = '0',
    ...
    def testBaseSpaceBioSample(self):
        """Test BaseSpaceBioSample"""
