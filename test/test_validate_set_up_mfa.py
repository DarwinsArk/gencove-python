...
class TestValidateSetUpMFA(unittest.TestCase):
    """ValidateSetUpMFA unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateSetUpMFA:
        """Test ValidateSetUpMFA
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ValidateSetUpMFA`
        """
        model = ValidateSetUpMFA()
        if include_optional:
            return ValidateSetUpMFA(
                token = '0',
                backup_tokens = [
                    ''
                    ]
