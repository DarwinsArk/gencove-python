...
class TestGetExplorerDataCredentialsResponse(unittest.TestCase):
    """GetExplorerDataCredentialsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetExplorerDataCredentialsResponse:
        """Test GetExplorerDataCredentialsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `GetExplorerDataCredentialsResponse`
        """
        model = GetExplorerDataCredentialsResponse()
        if include_optional:
            return GetExplorerDataCredentialsResponse(
                version = 56,
                access_key = '0',
                secret_key = '0',
                token = '0',
    ...
    def testGetExplorerDataCredentialsResponse(self):
        """Test GetExplorerDataCredentialsResponse"""
