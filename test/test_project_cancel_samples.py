...
class TestProjectCancelSamples(unittest.TestCase):
    """ProjectCancelSamples unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectCancelSamples:
        """Test ProjectCancelSamples
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectCancelSamples`
        """
        model = ProjectCancelSamples()
        if include_optional:
            return ProjectCancelSamples(
                sample_ids = [
                    ''
                    ]
            )
    ...
    def testProjectCancelSamples(self):
        """Test ProjectCancelSamples"""
