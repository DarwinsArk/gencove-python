...
class TestBasespaceProjectsList200Response(unittest.TestCase):
    """BasespaceProjectsList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BasespaceProjectsList200Response:
        """Test BasespaceProjectsList200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BasespaceProjectsList200Response`
        """
        model = BasespaceProjectsList200Response()
        if include_optional:
            return BasespaceProjectsList200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.base_space_project.BaseSpaceProject(
                        basespace_id = '0',
                        basespace_name = '0',
                        basespace_description = '0',
    ...
    def testBasespaceProjectsList200Response(self):
        """Test BasespaceProjectsList200Response"""
