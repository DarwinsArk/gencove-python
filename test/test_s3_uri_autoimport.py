...
class TestS3URIAutoimport(unittest.TestCase):
    """S3URIAutoimport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> S3URIAutoimport:
        """Test S3URIAutoimport
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `S3URIAutoimport`
        """
        model = S3URIAutoimport()
        if include_optional:
            return S3URIAutoimport(
                id = '',
                project_id = '',
                s3_uri = '0',
