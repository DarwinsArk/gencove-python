...
class TestUploadPostDataResponse(unittest.TestCase):
    """UploadPostDataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadPostDataResponse:
        """Test UploadPostDataResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UploadPostDataResponse`
        """
        model = UploadPostDataResponse()
        if include_optional:
            return UploadPostDataResponse(
                id = '',
                destination_path = '0',
                s3 = gencove_client.models.s3_object_nested.S3ObjectNested(
                    bucket = '0',
                    object_name = '0', ),
    ...
    def testUploadPostDataResponse(self):
        """Test UploadPostDataResponse"""
