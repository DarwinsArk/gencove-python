...
class TestBaseSpaceProjectsAutoimportCreate(unittest.TestCase):
    """BaseSpaceProjectsAutoimportCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseSpaceProjectsAutoimportCreate:
        """Test BaseSpaceProjectsAutoimportCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BaseSpaceProjectsAutoimportCreate`
        """
        model = BaseSpaceProjectsAutoimportCreate()
        if include_optional:
            return BaseSpaceProjectsAutoimportCreate(
                id = '',
    ...
    def testBaseSpaceProjectsAutoimportCreate(self):
        """Test BaseSpaceProjectsAutoimportCreate"""
