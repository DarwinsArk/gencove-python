...
class TestSubscriptionSecret(unittest.TestCase):
    """SubscriptionSecret unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionSecret:
        """Test SubscriptionSecret
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SubscriptionSecret`
        """
        model = SubscriptionSecret()
        if include_optional:
    ...
    def testSubscriptionSecret(self):
        """Test SubscriptionSecret"""
