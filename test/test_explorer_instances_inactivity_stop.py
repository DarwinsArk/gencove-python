...
class TestExplorerInstancesInactivityStop(unittest.TestCase):
    """ExplorerInstancesInactivityStop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExplorerInstancesInactivityStop:
        """Test ExplorerInstancesInactivityStop
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExplorerInstancesInactivityStop`
        """
        model = ExplorerInstancesInactivityStop()
        if include_optional:
            return ExplorerInstancesInactivityStop(
                instance_ids = [
                    ''
                    ],
                stop_after_inactivity_hours = 56
            )
        else:
            return ExplorerInstancesInactivityStop(
                instance_ids = [
    ...
    def testExplorerInstancesInactivityStop(self):
        """Test ExplorerInstancesInactivityStop"""
