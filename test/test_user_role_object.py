...
class TestUserRoleObject(unittest.TestCase):
    """UserRoleObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserRoleObject:
        """Test UserRoleObject
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UserRoleObject`
        """
        model = UserRoleObject()
        if include_optional:
