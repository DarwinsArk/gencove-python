...
class TestProjectSubscriptionEventTypesList200Response(unittest.TestCase):
    """ProjectSubscriptionEventTypesList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSubscriptionEventTypesList200Response:
        """Test ProjectSubscriptionEventTypesList200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectSubscriptionEventTypesList200Response`
        """
        model = ProjectSubscriptionEventTypesList200Response()
        if include_optional:
            return ProjectSubscriptionEventTypesList200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.event_type.EventType(
                        key = '0',
                        description = '0', )
                    ]
            )
    ...
    def testProjectSubscriptionEventTypesList200Response(self):
        """Test ProjectSubscriptionEventTypesList200Response"""
