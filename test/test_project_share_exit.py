...
class TestProjectShareExit(unittest.TestCase):
    """ProjectShareExit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectShareExit:
        """Test ProjectShareExit
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectShareExit`
        """
        model = ProjectShareExit()
        if include_optional:
            return ProjectShareExit(
                project_ids = [
                    ''
                    ]
            )
