...
class TestUploadNestedCreate(unittest.TestCase):
    """UploadNestedCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadNestedCreate:
        """Test UploadNestedCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UploadNestedCreate`
        """
        model = UploadNestedCreate()
        if include_optional:
            return UploadNestedCreate(
                upload = ''
            )
        else:
            return UploadNestedCreate(
    ...
    def testUploadNestedCreate(self):
        """Test UploadNestedCreate"""
