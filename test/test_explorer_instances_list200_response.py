...
class TestExplorerInstancesList200Response(unittest.TestCase):
    """ExplorerInstancesList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExplorerInstancesList200Response:
        """Test ExplorerInstancesList200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExplorerInstancesList200Response`
        """
        model = ExplorerInstancesList200Response()
        if include_optional:
            return ExplorerInstancesList200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.explorer_instance.ExplorerInstance(
                        id = '',
                        status = '',
                        stop_after_inactivity_hours = 0, )
                    ]
            )
        else:
            return ExplorerInstancesList200Response(
    ...
    def testExplorerInstancesList200Response(self):
        """Test ExplorerInstancesList200Response"""
