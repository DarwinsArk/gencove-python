...
class TestAncestrySelfNested(unittest.TestCase):
    """AncestrySelfNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AncestrySelfNested:
        """Test AncestrySelfNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `AncestrySelfNested`
        """
        model = AncestrySelfNested()
        if include_optional:
            return AncestrySelfNested(
    ...
    def testAncestrySelfNested(self):
        """Test AncestrySelfNested"""
