...
class TestSampleStatusList(unittest.TestCase):
    """SampleStatusList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SampleStatusList:
        """Test SampleStatusList
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleStatusList`
        """
        model = SampleStatusList()
        if include_optional:
