...
class TestSampleCounts(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SampleCounts:
        """Test SampleCounts
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SampleCounts`
        """
        model = SampleCounts()
        if include_optional:
            return SampleCounts(
                total_samples = 56,
                running_samples = 56,
                scheduled_samples = 56,
                succeeded_samples = 56,
                failed_samples = 56
            )
        else:
            return SampleCounts(
