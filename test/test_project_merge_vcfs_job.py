...
class TestProjectMergeVCFsJob(unittest.TestCase):
    """ProjectMergeVCFsJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectMergeVCFsJob:
        """Test ProjectMergeVCFsJob
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectMergeVCFsJob`
        """
        model = ProjectMergeVCFsJob()
        if include_optional:
            return ProjectMergeVCFsJob(
                id = '',
                created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                user = '',
                last_status = gencove_client.models.job_status_nested.JobStatusNested(
                    id = '',
                    status = '0',
                    note = '',
                    created = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), ),
    ...
    def testProjectMergeVCFsJob(self):
        """Test ProjectMergeVCFsJob"""
