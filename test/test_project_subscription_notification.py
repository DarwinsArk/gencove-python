...
class TestProjectSubscriptionNotification(unittest.TestCase):
    """ProjectSubscriptionNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectSubscriptionNotification:
        """Test ProjectSubscriptionNotification
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectSubscriptionNotification`
        """
        model = ProjectSubscriptionNotification()
        if include_optional:
            return ProjectSubscriptionNotification(
                id = '',
    ...
    def testProjectSubscriptionNotification(self):
        """Test ProjectSubscriptionNotification"""
