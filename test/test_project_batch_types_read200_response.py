...
class TestProjectBatchTypesRead200Response(unittest.TestCase):
    """ProjectBatchTypesRead200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectBatchTypesRead200Response:
        """Test ProjectBatchTypesRead200Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectBatchTypesRead200Response`
        """
        model = ProjectBatchTypesRead200Response()
        if include_optional:
            return ProjectBatchTypesRead200Response(
                meta = gencove_client.models.basespace_project_biosamples_read_200_response_meta.basespace_project_biosamples_read_200_response_meta(
                    ...
                    previous = '', ),
                results = [
                    gencove_client.models.batch_type.BatchType(
                        key = '0',
                        description = '', )
                    ]
            )
    ...
    def testProjectBatchTypesRead200Response(self):
        """Test ProjectBatchTypesRead200Response"""
