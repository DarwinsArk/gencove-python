...
class TestDeletedUnassignedUploads(unittest.TestCase):
    """DeletedUnassignedUploads unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeletedUnassignedUploads:
        """Test DeletedUnassignedUploads
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `DeletedUnassignedUploads`
        """
        model = DeletedUnassignedUploads()
        if include_optional:
            return DeletedUnassignedUploads(
                upload_ids = [
                    ''
                    ]
            )
    ...
    def testDeletedUnassignedUploads(self):
        """Test DeletedUnassignedUploads"""
