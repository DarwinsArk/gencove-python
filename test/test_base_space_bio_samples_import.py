...
class TestBaseSpaceBioSamplesImport(unittest.TestCase):
    """BaseSpaceBioSamplesImport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseSpaceBioSamplesImport:
        """Test BaseSpaceBioSamplesImport
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BaseSpaceBioSamplesImport`
        """
        model = BaseSpaceBioSamplesImport()
        if include_optional:
            return BaseSpaceBioSamplesImport(
                project_id = '',
                basespace_bio_samples = [
                    gencove_client.models.base_space_bio_sample_nested.BaseSpaceBioSampleNested(
                        basespace_id = '0',
                        client_id = '0',
                        sample = '', )
                    ],
    ...
    def testBaseSpaceBioSamplesImport(self):
        """Test BaseSpaceBioSamplesImport"""
