...
class TestS3ProjectsAutoimportCreate(unittest.TestCase):
    """S3ProjectsAutoimportCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> S3ProjectsAutoimportCreate:
        """Test S3ProjectsAutoimportCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `S3ProjectsAutoimportCreate`
        """
        model = S3ProjectsAutoimportCreate()
        if include_optional:
            return S3ProjectsAutoimportCreate(
                id = '',
                topic_arn = ''
            )
        else:
    ...
    def testS3ProjectsAutoimportCreate(self):
        """Test S3ProjectsAutoimportCreate"""
