...
class TestBatchStatusNested(unittest.TestCase):
    """BatchStatusNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchStatusNested:
        """Test BatchStatusNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BatchStatusNested`
        """
        model = BatchStatusNested()
        if include_optional:
            return BatchStatusNested(
                id = '',
                status = '0',
    ...
    def testBatchStatusNested(self):
        """Test BatchStatusNested"""
