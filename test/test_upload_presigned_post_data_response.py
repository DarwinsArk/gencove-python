...
class TestUploadPresignedPostDataResponse(unittest.TestCase):
    """UploadPresignedPostDataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadPresignedPostDataResponse:
        """Test UploadPresignedPostDataResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UploadPresignedPostDataResponse`
        """
        model = UploadPresignedPostDataResponse()
        if include_optional:
            return UploadPresignedPostDataResponse(
                url = '0',
                fields = gencove_client.models.aws_presigned_post_data.AWSPresignedPostData(
                    key = '0',
                    aws_access_key_id = '0',
                    policy = '0',
                    signature = '0', )
    ...
    def testUploadPresignedPostDataResponse(self):
        """Test UploadPresignedPostDataResponse"""
