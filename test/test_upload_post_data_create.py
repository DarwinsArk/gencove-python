...
class TestUploadPostDataCreate(unittest.TestCase):
    """UploadPostDataCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadPostDataCreate:
        """Test UploadPostDataCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UploadPostDataCreate`
        """
        model = UploadPostDataCreate()
        if include_optional:
            return UploadPostDataCreate(
                destination_path = '0'
            )
        else:
            return UploadPostDataCreate(
    ...
    def testUploadPostDataCreate(self):
        """Test UploadPostDataCreate"""
