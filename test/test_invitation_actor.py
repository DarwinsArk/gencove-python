...
class TestInvitationActor(unittest.TestCase):
    """InvitationActor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InvitationActor:
        """Test InvitationActor
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `InvitationActor`
        """
        model = InvitationActor()
        if include_optional:
