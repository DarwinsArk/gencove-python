...
class TestBatchFileNested(unittest.TestCase):
    """BatchFileNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchFileNested:
        """Test BatchFileNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BatchFileNested`
        """
        model = BatchFileNested()
        if include_optional:
            return BatchFileNested(
                id = '',
                s3_path = '',
