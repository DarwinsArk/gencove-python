...
class TestBatchDetail(unittest.TestCase):
    """BatchDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchDetail:
        """Test BatchDetail
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BatchDetail`
        """
        model = BatchDetail()
        if include_optional:
            return BatchDetail(
