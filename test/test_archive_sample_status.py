...
class TestArchiveSampleStatus(unittest.TestCase):
    """ArchiveSampleStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArchiveSampleStatus:
        """Test ArchiveSampleStatus
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ArchiveSampleStatus`
        """
        model = ArchiveSampleStatus()
        if include_optional:
            return ArchiveSampleStatus(
                id = '0',
                status = '0',
                created = '0',
    ...
    def testArchiveSampleStatus(self):
        """Test ArchiveSampleStatus"""
