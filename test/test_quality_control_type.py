...
class TestQualityControlType(unittest.TestCase):
    """QualityControlType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QualityControlType:
        """Test QualityControlType
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `QualityControlType`
        """
    ...
    def testQualityControlType(self):
        """Test QualityControlType"""
