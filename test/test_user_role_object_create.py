...
class TestUserRoleObjectCreate(unittest.TestCase):
    """UserRoleObjectCreate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UserRoleObjectCreate:
        """Test UserRoleObjectCreate
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `UserRoleObjectCreate`
        """
        model = UserRoleObjectCreate()
        if include_optional:
            return UserRoleObjectCreate(
                user = '',
                role = '0'
            )
        else:
    ...
    def testUserRoleObjectCreate(self):
        """Test UserRoleObjectCreate"""
