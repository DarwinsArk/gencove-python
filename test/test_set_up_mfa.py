...
class TestSetUpMFA(unittest.TestCase):
    """SetUpMFA unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetUpMFA:
        """Test SetUpMFA
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SetUpMFA`
        """
        model = SetUpMFA()
        if include_optional:
            return SetUpMFA(
