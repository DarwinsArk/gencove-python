...
class TestProjectShareRevoke(unittest.TestCase):
    """ProjectShareRevoke unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectShareRevoke:
        """Test ProjectShareRevoke
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectShareRevoke`
        """
        model = ProjectShareRevoke()
        if include_optional:
            return ProjectShareRevoke(
                id = ''
            )
        else:
            return ProjectShareRevoke(
    ...
    def testProjectShareRevoke(self):
        """Test ProjectShareRevoke"""
