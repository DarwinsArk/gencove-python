...
class TestExplorerCostReportRecord(unittest.TestCase):
    """ExplorerCostReportRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExplorerCostReportRecord:
        """Test ExplorerCostReportRecord
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExplorerCostReportRecord`
        """
        model = ExplorerCostReportRecord()
        if include_optional:
            return ExplorerCostReportRecord(
                id = '',
    ...
    def testExplorerCostReportRecord(self):
        """Test ExplorerCostReportRecord"""
