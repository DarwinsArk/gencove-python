...
class TestS3URIImport(unittest.TestCase):
    """S3URIImport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> S3URIImport:
        """Test S3URIImport
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `S3URIImport`
        """
        model = S3URIImport()
        if include_optional:
            return S3URIImport(
