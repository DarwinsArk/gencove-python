...
class TestSocialDisconnect(unittest.TestCase):
    """SocialDisconnect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialDisconnect:
        """Test SocialDisconnect
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SocialDisconnect`
        """
        model = SocialDisconnect()
        if include_optional:
            return SocialDisconnect(
                provider = '0'
            )
        else:
            return SocialDisconnect(
