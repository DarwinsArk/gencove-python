...
class TestExplorerShellSessionCredentialsResponse(unittest.TestCase):
    """ExplorerShellSessionCredentialsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExplorerShellSessionCredentialsResponse:
        """Test ExplorerShellSessionCredentialsResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExplorerShellSessionCredentialsResponse`
        """
        model = ExplorerShellSessionCredentialsResponse()
        if include_optional:
            return ExplorerShellSessionCredentialsResponse(
                version = 56,
                access_key = '0',
                secret_key = '0',
                token = '0',
                ...
                region_name = '0',
                ec2_instance_id = '0',
                shell_session_ssm_document_name = '0',
                network_activity_ssm_document_name = '0'
            )
        else:
            return ExplorerShellSessionCredentialsResponse(
                version = 56,
    ...
    def testExplorerShellSessionCredentialsResponse(self):
        """Test ExplorerShellSessionCredentialsResponse"""
