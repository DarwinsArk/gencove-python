...
class TestTraitDistribution(unittest.TestCase):
    """TraitDistribution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TraitDistribution:
        """Test TraitDistribution
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TraitDistribution`
        """
        model = TraitDistribution()
        if include_optional:
    ...
    def testTraitDistribution(self):
        """Test TraitDistribution"""
