...
class TestExplorerInstancesStart(unittest.TestCase):
    """ExplorerInstancesStart unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExplorerInstancesStart:
        """Test ExplorerInstancesStart
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExplorerInstancesStart`
        """
        model = ExplorerInstancesStart()
        if include_optional:
            return ExplorerInstancesStart(
                instance_ids = [
                    ''
                    ]
            )
    ...
    def testExplorerInstancesStart(self):
        """Test ExplorerInstancesStart"""
