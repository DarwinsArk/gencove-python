...
class TestBaseSpaceProjectsAutoimport(unittest.TestCase):
    """BaseSpaceProjectsAutoimport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseSpaceProjectsAutoimport:
        """Test BaseSpaceProjectsAutoimport
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BaseSpaceProjectsAutoimport`
        """
        model = BaseSpaceProjectsAutoimport()
        if include_optional:
            return BaseSpaceProjectsAutoimport(
                id = '',
                project_id = '',
                identifier = '0',
    ...
    def testBaseSpaceProjectsAutoimport(self):
        """Test BaseSpaceProjectsAutoimport"""
