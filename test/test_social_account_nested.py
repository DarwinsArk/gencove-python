...
class TestSocialAccountNested(unittest.TestCase):
    """SocialAccountNested unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SocialAccountNested:
        """Test SocialAccountNested
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `SocialAccountNested`
        """
        model = SocialAccountNested()
        if include_optional:
            return SocialAccountNested(
                id = '',
    ...
    def testSocialAccountNested(self):
        """Test SocialAccountNested"""
