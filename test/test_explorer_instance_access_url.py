...
class TestExplorerInstanceAccessURL(unittest.TestCase):
    """ExplorerInstanceAccessURL unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExplorerInstanceAccessURL:
        """Test ExplorerInstanceAccessURL
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExplorerInstanceAccessURL`
        """
        model = ExplorerInstanceAccessURL()
        if include_optional:
            return ExplorerInstanceAccessURL(
                id = '',
    ...
    def testExplorerInstanceAccessURL(self):
        """Test ExplorerInstanceAccessURL"""
