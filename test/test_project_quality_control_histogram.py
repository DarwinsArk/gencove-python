...
class TestProjectQualityControlHistogram(unittest.TestCase):
    """ProjectQualityControlHistogram unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectQualityControlHistogram:
        """Test ProjectQualityControlHistogram
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ProjectQualityControlHistogram`
        """
        model = ProjectQualityControlHistogram()
        if include_optional:
            return ProjectQualityControlHistogram(
                bin_edges = [
                    1.337
                    ],
                hist = [
    ...
    def testProjectQualityControlHistogram(self):
        """Test ProjectQualityControlHistogram"""
