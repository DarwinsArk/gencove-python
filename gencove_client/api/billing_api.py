...
class BillingApi:
    ...
    def billing_portal_create(
        ...
        _param = self._billing_portal_create_serialize(
            data=data,
    ...
    @validate_call
    def billing_portal_create_with_http_info(
        self,
        data: BillingPortal,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def billing_portal_create_without_preload_content(
        self,
        data: BillingPortal,
        _request_timeout: Union[
            None,
    ...
    def _billing_portal_create_serialize(
        self,
        data,
        _request_auth,
        _content_type,
