...
class RoleApi:
    ...
    def roles_list(
        self,
        applies_to: Annotated[StrictStr, Field(description="Filter roles by permission being applied to.")],
        ...
        :param applies_to: Filter roles by permission being applied to. (required)
        :type applies_to: str
    ...
    def _roles_list_serialize(
        ...
        if applies_to is not None:
            _path_params["applies_to"] = applies_to
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/roles/{applies_to}",
