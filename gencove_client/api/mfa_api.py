...
class MfaApi:
    ...
    def mfa_disable_delete(
        ...
        _param = self._mfa_disable_delete_serialize(
    ...
    @validate_call
    def mfa_disable_delete_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def mfa_disable_delete_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _mfa_disable_delete_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def mfa_setup_create(
        ...
        _param = self._mfa_setup_create_serialize(
            data=data,
            _request_auth=_request_auth,
    ...
    @validate_call
    def mfa_setup_create_with_http_info(
        self,
        data: SetUpMFA,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def mfa_setup_create_without_preload_content(
        self,
        data: SetUpMFA,
        _request_timeout: Union[
            None,
    ...
    def _mfa_setup_create_serialize(
        self,
        data,
        _request_auth,
        _content_type,
    ...
    def mfa_status_list(
        ...
        _param = self._mfa_status_list_serialize(
            _request_auth=_request_auth, _content_type=_content_type, _headers=_headers, _host_index=_host_index
        )
    ...
    @validate_call
    def mfa_status_list_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def mfa_status_list_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _mfa_status_list_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def mfa_validate_create(
        self,
        data: ValidateSetUpMFA,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
        ...
        _param = self._mfa_validate_create_serialize(
            data=data,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def mfa_validate_create_with_http_info(
        self,
        data: ValidateSetUpMFA,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def mfa_validate_create_without_preload_content(
        self,
        data: ValidateSetUpMFA,
        _request_timeout: Union[
            None,
    ...
    def _mfa_validate_create_serialize(
        self,
        data,
        _request_auth,
        _content_type,
