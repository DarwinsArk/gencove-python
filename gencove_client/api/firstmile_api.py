...
class FirstmileApi:
    ...
    @validate_call
    def firstmile_s3_role_element_create(
        self,
        data: S3RoleElement,
        ...
        _param = self._firstmile_s3_role_element_create_serialize(
            data=data,
    ...
    @validate_call
    def firstmile_s3_role_element_create_with_http_info(
        self,
        data: S3RoleElement,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def firstmile_s3_role_element_create_without_preload_content(
        self,
        data: S3RoleElement,
        _request_timeout: Union[
            None,
    ...
    def _firstmile_s3_role_element_create_serialize(
        self,
        data,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/firstmile-s3-role-element/",
    ...
    @validate_call
    def firstmile_s3_role_element_read(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._firstmile_s3_role_element_read_serialize(
    ...
    @validate_call
    def firstmile_s3_role_element_read_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def firstmile_s3_role_element_read_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _firstmile_s3_role_element_read_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def firstmile_validate_illumina_samplesheet_create(
        self,
        illumina_samplesheet: Annotated[
            Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
            Field(description="Illumina SampleSheet.csv file"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param illumina_samplesheet: Illumina SampleSheet.csv file (required)
        :type illumina_samplesheet: bytearray
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._firstmile_validate_illumina_samplesheet_create_serialize(
            illumina_samplesheet=illumina_samplesheet,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    @validate_call
    def firstmile_validate_illumina_samplesheet_create_with_http_info(
        self,
        illumina_samplesheet: Annotated[
            Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
            Field(description="Illumina SampleSheet.csv file"),
    ...
    @validate_call
    def firstmile_validate_illumina_samplesheet_create_without_preload_content(
        self,
        illumina_samplesheet: Annotated[
            Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
            Field(description="Illumina SampleSheet.csv file"),
    ...
    def _firstmile_validate_illumina_samplesheet_create_serialize(
        self,
        ...
        # process the header parameters
        # process the form parameters
        if illumina_samplesheet is not None:
            _files["illumina_samplesheet"] = illumina_samplesheet
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/firstmile-validate-illumina-samplesheet/",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
