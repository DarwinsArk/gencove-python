...
class FileApi:
    ...
    def file_types_list(
        self,
        project_id: Annotated[Optional[StrictStr], Field(description="List file types for a project")] = None,
        object: Annotated[
            Optional[StrictStr], Field(description="List file types for a specific object, defaults to sample")
        ] = None,
        ...
        :param project_id: List file types for a project
        :type project_id: str
        :param object: List file types for a specific object, defaults to sample
        :type object: str
        ...
        _param = self._file_types_list_serialize(
    ...
    @validate_call
    def file_types_list_with_http_info(
        self,
        project_id: Annotated[Optional[StrictStr], Field(description="List file types for a project")] = None,
        object: Annotated[
            Optional[StrictStr], Field(description="List file types for a specific object, defaults to sample")
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FileTypesList200Response]:
        """file_types_list
    ...
    @validate_call
    def file_types_list_without_preload_content(
        self,
        project_id: Annotated[Optional[StrictStr], Field(description="List file types for a project")] = None,
        object: Annotated[
            Optional[StrictStr], Field(description="List file types for a specific object, defaults to sample")
    ...
    def _file_types_list_serialize(
        self,
        project_id,
        object,
        _request_auth,
    ...
    def files_read(
        ...
        _param = self._files_read_serialize(
            file_id=file_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def files_read_without_preload_content(
        self,
        file_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _files_read_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/files/{file_id}.sha256",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
