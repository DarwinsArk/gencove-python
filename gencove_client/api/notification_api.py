...
class NotificationApi:
    ...
    def notifications_read(
        ...
        _param = self._notifications_read_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            "200": "ProjectSubscriptionNotificationDetail",
        }
    ...
    @validate_call
    def notifications_read_with_http_info(
        self,
        notification_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProjectSubscriptionNotificationDetail]:
        """notifications_read
    ...
    @validate_call
    def notifications_read_without_preload_content(
        self,
        notification_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _notifications_read_serialize(
        self,
        notification_id,
        _request_auth,
        _content_type,
