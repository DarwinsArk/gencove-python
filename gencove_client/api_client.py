...
from gencove_client.api_response import ApiResponse, T as ApiResponseT
import gencove_client.models
from gencove_client import rest
from gencove_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(gencove_client.models, klass)
