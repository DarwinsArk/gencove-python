...
class BaseSpaceProjectsImport(BaseModel):
    """
    BaseSpaceProjectsImport
    """  # noqa: E501

    project_id: StrictStr
    basespace_project_ids: List[Annotated[str, Field(min_length=1, strict=True)]]
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["project_id", "basespace_project_ids", "metadata"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "basespace_project_ids": obj.get("basespace_project_ids"),
