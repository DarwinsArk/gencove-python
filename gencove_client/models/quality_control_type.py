...
class QualityControlType(BaseModel):
    ...
    key: Annotated[str, Field(min_length=1, strict=True, max_length=254)]
    type: Annotated[str, Field(min_length=1, strict=True)]
    name: Optional[StrictStr] = None
    description_markdown: Optional[StrictStr] = None
    display_type: Optional[StrictStr] = None
    display_only_if_failed: Optional[StrictStr] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "display_only_if_failed": obj.get("display_only_if_failed"),
            }
        )
        return _obj
