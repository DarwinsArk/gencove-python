...
class ProjectStats(BaseModel):
    ...
    failed_counts: Dict[str, Optional[StrictStr]]
    failed_qc_counts: Dict[str, Optional[StrictStr]]
    __properties: ClassVar[List[str]] = ["counts", "total_size", "failed_counts", "failed_qc_counts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "counts": SampleCounts.from_dict(obj["counts"]) if obj.get("counts") is not None else None,
                "total_size": obj.get("total_size"),
                "failed_counts": obj.get("failed_counts"),
                "failed_qc_counts": obj.get("failed_qc_counts"),
            }
        )
        return _obj
