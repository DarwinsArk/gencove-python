...
class BillingPortal(BaseModel):
    ...
    billing_portal_url: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(
        default=None, description="Billing portal URL to go to."
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"billing_portal_url": obj.get("billing_portal_url")})
        return _obj
