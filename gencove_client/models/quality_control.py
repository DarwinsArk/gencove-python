...
class QualityControl(BaseModel):
    ...
    quality_control: QualityControlSelfNested
    __properties: ClassVar[List[str]] = ["quality_control_type", "quality_control"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of quality_control_type
        if self.quality_control_type:
            _dict["quality_control_type"] = self.quality_control_type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of quality_control
        if self.quality_control:
            _dict["quality_control"] = self.quality_control.to_dict()
        return _dict
        ...
        _obj = cls.model_validate(
            {
                "quality_control_type": (
                    QualityControlType.from_dict(obj["quality_control_type"])
                    if obj.get("quality_control_type") is not None
                    else None
                ),
                "quality_control": (
                    QualityControlSelfNested.from_dict(obj["quality_control"])
                    if obj.get("quality_control") is not None
                    else None
                ),
            }
        )
