...
class BaseSpaceBioSample(BaseModel):
    ...
    basespace_id: Annotated[str, Field(min_length=1, strict=True)]
    basespace_bio_sample_name: Annotated[str, Field(min_length=1, strict=True)]
    basespace_date_created: datetime
    basespace_date_modified: datetime
    basespace_status: Annotated[str, Field(min_length=1, strict=True)]
    basespace_lab_status: Annotated[str, Field(min_length=1, strict=True)]
    basespace_user_owned_by_id: Annotated[str, Field(min_length=1, strict=True)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "basespace_id": obj.get("basespace_id"),
                "basespace_bio_sample_name": obj.get("basespace_bio_sample_name"),
                "basespace_date_created": obj.get("basespace_date_created"),
                "basespace_date_modified": obj.get("basespace_date_modified"),
                "basespace_status": obj.get("basespace_status"),
                "basespace_lab_status": obj.get("basespace_lab_status"),
                "basespace_user_owned_by_id": obj.get("basespace_user_owned_by_id"),
            }
        )
        return _obj
