...
class ExplorerInstancesInactivityStopOrganization(BaseModel):
    """
    ExplorerInstancesInactivityStopOrganization
    """  # noqa: E501

    explorer_override_stop_after_inactivity_hours: StrictBool
    explorer_stop_after_inactivity_hours: StrictInt = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "explorer_override_stop_after_inactivity_hours": obj.get(
                    "explorer_override_stop_after_inactivity_hours"
                ),
                "explorer_stop_after_inactivity_hours": obj.get("explorer_stop_after_inactivity_hours"),
            }
        )
        return _obj
