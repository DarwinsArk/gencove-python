...
class ValidateSetUpMFA(BaseModel):
    """
    ValidateSetUpMFA
    """  # noqa: E501

    token: Annotated[str, Field(min_length=1, strict=True)]
    backup_tokens: Optional[Annotated[List[Optional[StrictStr]], Field(min_length=10, max_length=10)]] = None
    __properties: ClassVar[List[str]] = ["token", "backup_tokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"token": obj.get("token"), "backup_tokens": obj.get("backup_tokens")})
        return _obj
