...
class SocialProvider(BaseModel):
    ...
    authorization_uri: Annotated[str, Field(min_length=1, strict=True)]
    accounts: Optional[List[SocialAccountNested]] = Field(default=None, description="User connected social account")
    __properties: ClassVar[List[str]] = ["name", "authorization_uri", "accounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "name": obj.get("name"),
                "authorization_uri": obj.get("authorization_uri"),
                "accounts": (
                    [SocialAccountNested.from_dict(_item) for _item in obj["accounts"]]
