...
class AWSPresignedPostData(BaseModel):
    """
    AWSPresignedPostData
    """  # noqa: E501

    key: Annotated[str, Field(min_length=1, strict=True)]
    aws_access_key_id: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="AWSAccessKeyId")
    policy: Annotated[str, Field(min_length=1, strict=True)]
    signature: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["key", "AWSAccessKeyId", "policy", "signature"]
