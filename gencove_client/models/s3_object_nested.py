...
class S3ObjectNested(BaseModel):
    """
    S3ObjectNested
    """  # noqa: E501

    bucket: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    object_name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["bucket", "object_name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"bucket": obj.get("bucket"), "object_name": obj.get("object_name")})
        return _obj
