...
class FastqsNestedCreate(BaseModel):
    """
    FastqsNestedCreate
    """  # noqa: E501

    r1: UploadNestedCreate
    r2: Optional[UploadNestedCreate] = None
    __properties: ClassVar[List[str]] = ["r1", "r2"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of r1
        if self.r1:
            _dict["r1"] = self.r1.to_dict()
        # override the default output from pydantic by calling `to_dict()` of r2
        if self.r2:
            _dict["r2"] = self.r2.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "r1": UploadNestedCreate.from_dict(obj["r1"]) if obj.get("r1") is not None else None,
                "r2": UploadNestedCreate.from_dict(obj["r2"]) if obj.get("r2") is not None else None,
            }
        )
        return _obj
