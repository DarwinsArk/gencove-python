...
class BatchCreate(BaseModel):
    ...
    batch_type: Annotated[str, Field(min_length=1, strict=True)]
    sample_ids: List[StrictStr] = Field(description="List of sample IDs or if empty all available samples will be used")
    __properties: ClassVar[List[str]] = ["name", "batch_type", "sample_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"name": obj.get("name"), "batch_type": obj.get("batch_type"), "sample_ids": obj.get("sample_ids")}
        )
        return _obj
