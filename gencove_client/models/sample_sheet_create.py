...
class SampleSheetCreate(BaseModel):
    ...
    fastq: FastqsNestedCreate
    sample: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["client_id", "fastq", "sample"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "fastq": FastqsNestedCreate.from_dict(obj["fastq"]) if obj.get("fastq") is not None else None,
