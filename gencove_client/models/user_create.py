...
class UserCreate(BaseModel):
    ...
    invitation_token: Optional[Annotated[str, Field(strict=True, max_length=32)]] = None
    organization_name: Optional[Annotated[str, Field(strict=True, max_length=254)]] = None
    __properties: ClassVar[List[str]] = ["email", "id", "password", "name", "invitation_token", "organization_name"]
