...
class TraitScoreSelfNested(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["value", "percentile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"value": obj.get("value"), "percentile": obj.get("percentile")})
        return _obj
