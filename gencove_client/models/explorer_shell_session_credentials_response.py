...
class ExplorerShellSessionCredentialsResponse(BaseModel):
    """
    ...
    region_name: Annotated[str, Field(min_length=1, strict=True)]
    ec2_instance_id: Annotated[str, Field(min_length=1, strict=True)]
    shell_session_ssm_document_name: Annotated[str, Field(min_length=1, strict=True)]
    network_activity_ssm_document_name: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = [
        ...
        "region_name",
        "ec2_instance_id",
        "shell_session_ssm_document_name",
        "network_activity_ssm_document_name",
    ]
        ...
        _obj = cls.model_validate(
            {
                ...
                "ec2_instance_id": obj.get("ec2_instance_id"),
                "shell_session_ssm_document_name": obj.get("shell_session_ssm_document_name"),
                "network_activity_ssm_document_name": obj.get("network_activity_ssm_document_name"),
            }
        )
        return _obj
