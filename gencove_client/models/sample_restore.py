...
class SampleRestore(BaseModel):
    """
    SampleRestore
    """  # noqa: E501

    sample_ids: List[StrictStr] = Field(description="List of sample IDs or if empty all archived samples will be used")
    restore_group_id: Optional[StrictStr] = None
    created: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["sample_ids", "restore_group_id", "created"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "restore_group_id": obj.get("restore_group_id"),
