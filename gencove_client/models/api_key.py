...
class APIKey(BaseModel):
    ...
    revoked: Optional[StrictBool] = Field(
        default=None, description="If the API key is revoked, clients cannot use it anymore. (This cannot be undone.)"
    )
    ...
    has_expired: Optional[StrictStr] = None
    ip_range: Optional[Dict[str, Any]] = Field(default=None, description="List of trusted subnets in CIDR notation")
    __properties: ClassVar[List[str]] = ["revoked", "id", "name", "prefix", "expiry_date", "has_expired", "ip_range"]
