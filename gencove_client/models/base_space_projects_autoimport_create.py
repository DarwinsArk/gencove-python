...
class BaseSpaceProjectsAutoimportCreate(BaseModel):
    """
    ...
    metadata: Optional[Dict[str, Any]] = Field(
        default=None, description="Additional information to be attached to the Sample instances."
    )
    action: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    __properties: ClassVar[List[str]] = ["id", "metadata", "action"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"id": obj.get("id"), "metadata": obj.get("metadata"), "action": obj.get("action")})
        return _obj
