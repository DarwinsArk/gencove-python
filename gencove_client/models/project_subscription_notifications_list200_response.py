        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [ProjectSubscriptionNotification.from_dict(_item) for _item in obj["results"]]
