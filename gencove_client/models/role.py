...
class Role(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Name of the role.")
    permissions: List[Optional[StrictStr]] = Field(description="List of the permissions the role has.")
