...
class SampleCounts(BaseModel):
    ...
    total_samples: StrictInt
    running_samples: StrictInt
    scheduled_samples: StrictInt
    succeeded_samples: StrictInt
    failed_samples: StrictInt
        ...
        _obj = cls.model_validate(
            {
                ...
                "running_samples": obj.get("running_samples"),
                "scheduled_samples": obj.get("scheduled_samples"),
                "succeeded_samples": obj.get("succeeded_samples"),
                "failed_samples": obj.get("failed_samples"),
            }
        )
        return _obj
