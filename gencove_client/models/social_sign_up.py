...
class SocialSignUp(BaseModel):
    ...
    code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Authorization code")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"provider": obj.get("provider"), "code": obj.get("code")})
        return _obj
