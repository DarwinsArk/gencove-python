...
class ArchiveSampleStatus(BaseModel):
    """
    ArchiveSampleStatus
    """  # noqa: E501
    ...
    created: Annotated[str, Field(min_length=1, strict=True)]
    transition_cutoff: Optional[datetime] = Field(
        default=None, description="Denotes the transition time for calculated states"
    )
    __properties: ClassVar[List[str]] = ["id", "status", "created", "transition_cutoff"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if transition_cutoff (nullable) is None
        # and model_fields_set contains the field
        if self.transition_cutoff is None and "transition_cutoff" in self.model_fields_set:
            _dict["transition_cutoff"] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "transition_cutoff": obj.get("transition_cutoff"),
            }
        )
        return _obj
