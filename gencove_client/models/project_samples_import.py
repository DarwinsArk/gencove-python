...
class ProjectSamplesImport(BaseModel):
    """
    ProjectSamplesImport
    """  # noqa: E501

    project_id: StrictStr
    samples: List[ExistingSample]
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["project_id", "samples", "metadata"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "samples": (
                    [ExistingSample.from_dict(_item) for _item in obj["samples"]]
