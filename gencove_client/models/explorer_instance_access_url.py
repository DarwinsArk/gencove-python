...
class ExplorerInstanceAccessURL(BaseModel):
    """
    ExplorerInstanceAccessURL
    """  # noqa: E501

    id: StrictStr
    access_token_expiration: Optional[Annotated[int, Field(le=86400, strict=True, ge=1)]] = Field(
        default=None, description="Number of seconds before the URL expires. Maximum is 86400 seconds."
    )
    __properties: ClassVar[List[str]] = ["id", "access_token_expiration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"id": obj.get("id"), "access_token_expiration": obj.get("access_token_expiration")})
        return _obj
