...
class S3ProjectsAutoimportCreate(BaseModel):
    """
    S3ProjectsAutoimportCreate
    """  # noqa: E501

    id: Optional[StrictStr] = None
    topic_arn: Optional[Annotated[str, Field(strict=True, max_length=768)]] = Field(
        default=None, description="SNS Topic where events of added samples will be received."
    )
    __properties: ClassVar[List[str]] = ["id", "topic_arn"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"id": obj.get("id"), "topic_arn": obj.get("topic_arn")})
        return _obj
