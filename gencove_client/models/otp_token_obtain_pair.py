...
class OTPTokenObtainPair(BaseModel):
    """
    OTPTokenObtainPair
    """  # noqa: E501

    otp_token: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    backup_token: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    email: Annotated[str, Field(min_length=1, strict=True)]
    password: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["otp_token", "backup_token", "email", "password"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "backup_token": obj.get("backup_token"),
                "email": obj.get("email"),
