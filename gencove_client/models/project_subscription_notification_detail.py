...
class ProjectSubscriptionNotificationDetail(BaseModel):
    """
    ...
    response_status: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]] = None
    notification_event_type: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(
        default=None, description="notification event type"
    )
    response_message: Optional[StrictStr] = None
    payload_url: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(
        default=None, description="presigned s3 url for the payload content"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # and model_fields_set contains the field
        if self.response_message is None and "response_message" in self.model_fields_set:
        ...
        _obj = cls.model_validate(
            {
                ...
                "notification_event_type": obj.get("notification_event_type"),
