...
class SampleHideUnhide(BaseModel):
    """
    SampleHideUnhide
    """  # noqa: E501

    sample_ids: List[StrictStr] = Field(description="List of sample IDs")
    __properties: ClassVar[List[str]] = ["sample_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"sample_ids": obj.get("sample_ids")})
        return _obj
