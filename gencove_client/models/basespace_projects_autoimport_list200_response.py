        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [BaseSpaceProjectsAutoimport.from_dict(_item) for _item in obj["results"]]
