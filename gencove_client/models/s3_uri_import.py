...
class S3URIImport(BaseModel):
    """
    S3URIImport
    """  # noqa: E501

    s3_uri: Annotated[str, Field(min_length=1, strict=True, max_length=734)]
    project_id: StrictStr
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["s3_uri", "project_id", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"s3_uri": obj.get("s3_uri"), "project_id": obj.get("project_id"), "metadata": obj.get("metadata")}
        )
        return _obj
