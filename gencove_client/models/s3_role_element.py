...
class S3RoleElement(BaseModel):
    """
    S3RoleElement
    """  # noqa: E501

    role_arn: Optional[Annotated[str, Field(strict=True, max_length=2048)]] = None
    external_id: Optional[StrictStr] = None
    aws_region: Optional[StrictStr] = None
    s3_bucket: Optional[Annotated[str, Field(strict=True, max_length=64)]] = None
    s3_prefix: Optional[Annotated[str, Field(strict=True, max_length=512)]] = None
    __properties: ClassVar[List[str]] = ["role_arn", "external_id", "aws_region", "s3_bucket", "s3_prefix"]
