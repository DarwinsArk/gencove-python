...
class ProjectUsers(BaseModel):
    ...
    roles: Optional[Dict[str, UserRoleObject]] = Field(
        default=None, description="Roles for the project in the organization."
    )
    is_support: Optional[StrictBool] = Field(
        default=None, description="Designates whether this user should be treated as a support."
    )
    __properties: ClassVar[List[str]] = ["id", "email", "is_active", "name", "roles", "is_support"]
