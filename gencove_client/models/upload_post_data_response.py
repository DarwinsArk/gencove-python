...
class UploadPostDataResponse(BaseModel):
    """
    UploadPostDataResponse
    """  # noqa: E501

    id: Optional[StrictStr] = None
    destination_path: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    s3: Optional[S3ObjectNested] = None
    last_status: Optional[UploadStatusNested] = None
    __properties: ClassVar[List[str]] = ["id", "destination_path", "s3", "last_status"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "s3": S3ObjectNested.from_dict(obj["s3"]) if obj.get("s3") is not None else None,
                "last_status": (
