        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [BatchList.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
                ),
            }
        )
        return _obj
