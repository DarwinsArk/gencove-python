...
class SampleStatusList(BaseModel):
    """
    SampleStatusList
    """  # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["status", "note", "created"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"status": obj.get("status"), "note": obj.get("note"), "created": obj.get("created")})
        return _obj
