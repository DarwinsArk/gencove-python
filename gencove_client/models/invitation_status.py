...
class InvitationStatus(BaseModel):
    ...
    actor: Optional[InvitationActor] = None
    __properties: ClassVar[List[str]] = ["id", "status", "created", "actor"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "actor": InvitationActor.from_dict(obj["actor"]) if obj.get("actor") is not None else None,
            }
        )
        return _obj
