...
class SampleSheet(BaseModel):
    ...
    client_id: Annotated[str, Field(min_length=1, strict=True, max_length=250)]
    fastq: Optional[UploadNestedList] = None
    __properties: ClassVar[List[str]] = ["client_id", "fastq"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of fastq
        if self.fastq:
            _dict["fastq"] = self.fastq.to_dict()
        return _dict
        ...
        _obj = cls.model_validate(
            {
                ...
                "fastq": UploadNestedList.from_dict(obj["fastq"]) if obj.get("fastq") is not None else None,
            }
        )
        return _obj
