...
class SetUsername(BaseModel):
    ...
    new_email: Annotated[str, Field(min_length=1, strict=True, max_length=254)]
    __properties: ClassVar[List[str]] = ["current_password", "new_email"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"current_password": obj.get("current_password"), "new_email": obj.get("new_email")})
        return _obj
