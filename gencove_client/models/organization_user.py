...
class OrganizationUser(BaseModel):
    ...
    has_mfa_device: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "email", "is_active", "has_mfa_device", "name", "roles", "is_support"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "has_mfa_device": obj.get("has_mfa_device"),
                "name": obj.get("name"),
                "roles": (
