...
class BaseSpaceBioSampleNested(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["basespace_id", "client_id", "sample"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"basespace_id": obj.get("basespace_id"), "client_id": obj.get("client_id"), "sample": obj.get("sample")}
        )
        return _obj
