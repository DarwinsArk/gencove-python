...
class UploadPresignedPostDataResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "url": obj.get("url"),
                "fields": AWSPresignedPostData.from_dict(obj["fields"]) if obj.get("fields") is not None else None,
            }
        )
        return _obj
