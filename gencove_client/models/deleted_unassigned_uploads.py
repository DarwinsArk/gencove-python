...
class DeletedUnassignedUploads(BaseModel):
    """
    DeletedUnassignedUploads
    """  # noqa: E501

    upload_ids: List[StrictStr]
    __properties: ClassVar[List[str]] = ["upload_ids"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"upload_ids": obj.get("upload_ids")})
        return _obj
