...
class ProjectSamplesList200ResponseResultsInnerLastStatus(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "note", "created"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"id": obj.get("id"), "status": obj.get("status"), "note": obj.get("note"), "created": obj.get("created")}
        )
        return _obj
