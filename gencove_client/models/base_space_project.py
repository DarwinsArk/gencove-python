...
class BaseSpaceProject(BaseModel):
    ...
    basespace_name: Annotated[str, Field(min_length=1, strict=True)]
    basespace_description: Annotated[str, Field(min_length=1, strict=True)]
        ...
        _obj = cls.model_validate(
            {
                ...
                "basespace_name": obj.get("basespace_name"),
                "basespace_description": obj.get("basespace_description"),
