...
class ExplorerInstance(BaseModel):
    ...
    stop_after_inactivity_hours: Optional[Annotated[int, Field(le=4294967295, strict=True, ge=0)]] = Field(
        default=None,
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "stop_after_inactivity_hours"]
