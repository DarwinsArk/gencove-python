...
class ProjectMergeVCFsJob(BaseModel):
    """
    ProjectMergeVCFsJob
    """  # noqa: E501
    ...
    user: StrictStr
    last_status: Optional[JobStatusNested] = None
    up_to_date: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["id", "created", "user", "last_status", "up_to_date"]
        ...
        _obj = cls.model_validate(
            {
                ...
                "user": obj.get("user"),
                "last_status": (
                    JobStatusNested.from_dict(obj["last_status"]) if obj.get("last_status") is not None else None
                ),
                "up_to_date": obj.get("up_to_date") if obj.get("up_to_date") is not None else False,
            }
        )
        return _obj
