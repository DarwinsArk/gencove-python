...
class ProjectSubscriptionEventTypesList200Response(BaseModel):
    """
        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [EventType.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
                ),
            }
        )
        return _obj
