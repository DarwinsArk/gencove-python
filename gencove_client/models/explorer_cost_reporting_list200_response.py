        ...
        _obj = cls.model_validate(
            {
                ...
                "results": (
                    [ExplorerCostReportRecord.from_dict(_item) for _item in obj["results"]]
