...
class UploadURLCreate(BaseModel):
    ...
    source_url: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["destination_path", "source_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"destination_path": obj.get("destination_path"), "source_url": obj.get("source_url")}
        )
        return _obj
