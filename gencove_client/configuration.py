...
class Configuration:
    ...
    conf = gencove_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "https://api.gencove.com/api/v2" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("gencove_client")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                "url": "https://api.gencove.com/api/v2",
